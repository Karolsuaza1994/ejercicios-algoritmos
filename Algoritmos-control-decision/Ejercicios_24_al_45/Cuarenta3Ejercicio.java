...
public class Cuarenta3Ejercicio {
    public static void main(String[] args) {
        double capital,prestamo,nuevoCapital,restante,insumos,incentivos;

        System.out.println("Capital actual:");
        capital=Double.parseDouble(System.console().readLine());

        if(capital<0) prestamo=10000-capital;
        else if(capital<=20000) prestamo=20000-capital;
        else prestamo=0;

        nuevoCapital=capital+prestamo;
        restante=nuevoCapital-5000-2000;
        insumos=restante/2;
